    ...
    page("home", {
      ...
      content: [
        hero({
          ...
          subtitle: "Deploy any application to production in under 90 seconds. Zero config. Automatic scaling. Built-in observability. The deployment platform engineers actually enjoy using.",
          cta: { label: "Get Started Free", url: "https://warpspeed.dev/signup" },
        }),
        spacer(),
        markdown(`**Trusted by 10,000+ developers** at companies like Stripe, Vercel, Linear, and Planetscale.`),
        spacer(),
        card({
      ...
      content: [
        table(
          ...
          [
            ...
            ["Edge regions", "3", "All (300+)", "All + dedicated"],
            ["Team members", "1", "10", "Unlimited"],
            ["Preview deploys", "5 concurrent", "Unlimited", "Unlimited + SSO"],
